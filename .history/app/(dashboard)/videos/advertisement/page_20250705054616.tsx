...
export default function AdvertisementVideosPage() {
  ...
  const API_BASE = process.env.NEXT_PUBLIC_API_URL || 'https://amris.duckdns.org/api'
  ...
  const fetchVideos = async () => {
    try {
      ...
      if (error instanceof Error && (
        ...
        console.warn('Certificate error detected while fetching videos');
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (error instanceof Error && (
        ...
        console.warn('Certificate error detected while uploading video');
        toast.error('Connection security issue. Please contact your administrator.')
      } else {
