  ...
  useEffect(() => {
    const checkConnection = async () => {
      try {
        ...
        // Make a simple request to check if the server is reachable
        const response = await fetch('https://t3h.dracode.org/api/health/', {
          method: 'GET',
          headers: {
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs text-gray-500">
              {connectionStatus === 'connected' && 'Connected to t3h.dracode.org'}
