...
- **Real-time Backend Connection**: Connected to `https://188.245.103.205/api`
...
**Backend Server**: `188.245.103.205`  
**API Base URL**: `https://188.245.103.205/api`  
